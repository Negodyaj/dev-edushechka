...
//            // When
//            var dto = _sut.GetStudentHomeworkId(dtoForTaskIdAndUserId.Task.Id, dtoForTaskIdAndUserId.User.Id, userInfo);
...
//            var dto = _sut.GetStudentHomeworkId(taskId, userId, userInfo);
...
//            _studentAnswerOnTaskRepoMock.Setup(x => x.GetStudentAnswerOnTaskByTaskIdAndStudentId(taskId, userId)).Returns(studentAnswerDto);
//            _studentAnswerOnTaskRepoMock.Setup(x => x.DeleteStudentHomework(taskId, userId));

//            // When
//            _sut.DeleteStudentAnswerOnTask(taskId, userId, userInfo);

//            // Than
//            _studentAnswerOnTaskRepoMock.Verify(x => x.DeleteStudentHomework(taskId, userId), Times.Once);
//            _studentAnswerOnTaskRepoMock.Verify(x => x.GetStudentAnswerOnTaskByTaskIdAndStudentId(taskId, userId), Times.Once);
//        }
...
//            // When
//            var actualException = Assert.Throws<EntityNotFoundException>(
//                () => _sut.GetStudentHomeworkId(taskId, studentAnswerOnTaskDto.User.Id, userInfo));
...
//            //When
//            var actualException = Assert.Throws<AuthorizationException>(
//                    () => _sut.GetStudentHomeworkId(taskId, expectedUserId, userInfo));
