...
namespace DevEdu.API.Controllers
{
    ...
    public class HomeworkController : Controller
    {
        ...
        {
            var dto = _homeworkService.GetHomework(id);
        ...
        {
            var dto = _homeworkService.GetHomeworkByGroupId(groupId);
        ...
        public HomeworkInfoOutputModel AddHomework(int groupId, int taskId, [FromBody] HomeworkInputModel model)
        {
            ...
            var hw = _homeworkService.AddHomework(groupId, taskId, dto);
        ...
        {
            var dto = _mapper.Map<HomeworkDto>(model);
            var output = _homeworkService.UpdateHomework(id, dto);
