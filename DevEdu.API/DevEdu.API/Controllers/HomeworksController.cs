...
namespace DevEdu.API.Controllers
{
    ...
    public class HomeworksController : Controller
    {
        ...
        public HomeworksController(IMapper mapper, IHomeworkService homeworkService)
        {
            _mapper = mapper;
        ...
        //  api/homeworks/by-group/{groupId}
        [AuthorizeRoles(Role.Teacher, Role.Tutor, Role.Student)]
        [HttpGet("by-group/{groupId}")]
        [Description("Get all homeworks by group")]
        ...
        //  api/homeworks/by-task/{taskId}
        [AuthorizeRoles(Role.Teacher)]
        [HttpGet("by-task/{taskId}")]
        [Description("Get all homeworks by task")]
