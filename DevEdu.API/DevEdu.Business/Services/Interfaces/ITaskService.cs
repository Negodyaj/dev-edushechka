...
namespace DevEdu.Business.Services
{
    public interface ITaskService
    {
        ...
        Task<TaskDto> AddTaskByTeacherAsync(TaskDto taskDto, int groupId, UserIdentityInfo userIdentityInfo);
        ...
        Task<List<TaskDto>> GetTasksByGroupIdAsync(int groupId, UserIdentityInfo userIdentityInfo);
